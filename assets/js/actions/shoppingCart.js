...
import {ACCESS_TOKEN, ADD_TO_CART, EDIT_CART, EMPTY_CART, REMOVE_FROM_CART, GOODS_AMOUNT} from "../api/strings";
...
export const removeFromCart = ({ productID } = {}) => {
    return (dispatch, getState) => {
        ...
        // if(authentication.isAuthenticated){
            ...
            axios.post(removeFromCartAPI,data, {headers: {...headers}})
                .then((response) => {
...
export const addToCart = (product = {}) => {
    return (dispatch, getState) => {
        ...
        // } else {
        //     const goodsAmount = window.localStorage.getItem(GOODS_AMOUNT);
        //
        // }
