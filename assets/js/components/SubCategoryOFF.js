    ...
    render(){
        ...
        return (
            <Grid>
                <Row>
                    <Col lg={12} md={12}>
                        <h1 className={"text-center subcategory-heading"}>
                            В ассортименте {SubCategory.firstLetterUppercase(this.props.match.params.subcategory)} следующие товары:
                        </h1>
                    </Col>
                </Row>

                {
                    this.state.productGroup.map((category) => {
                        return (
                            <Row>
                                <Col lg={12} md={12}>
                                    <h3 className={"text-center deal-heading"}>{category.name}</h3>
                ...
                {/*<Row>*/}
                    {/*<Col lg={2} md={2}>*/}
                        {/*<p className={"deal-heading"}>В наличии следующие товары</p>*/}
                    {/*</Col>*/}
